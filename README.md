...
A testing system for C, contained in 1 header file, by [Scott Vokes](https://github.com/silentbicycle).
...
And then include `greatest.h` as follows:
```c
#include "node_modules/greatest.c/greatest.h"
```
...
![](https://ga-beacon.deno.dev/G-RC63DPBH3P:SH3Eq-NoQ9mwgYeHWxu7cw/github.com/nodef/greatest.c)
[![SRC](https://img.shields.io/badge/src-repo-green?logo=Org)](https://github.com/silentbicycle/greatest)
